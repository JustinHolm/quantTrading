...
for e in exchanges:  
    for pair in pairs:
        ...
        r2 = result.rsquared
        b = result.params[1]
        sig = df_last_btc['close_BTC'].to_numpy()[0] / df_last_trade['close_BTC'].to_numpy()[0] -1
        fv = price * (1+sig)
        ...
        if output_file == True:
            ...
            if not file_exists:
                file1.writelines('timedate,pair,min_stale,signal,st_dev,price,fv,bid,ask,r2,beta'+ "\n")
